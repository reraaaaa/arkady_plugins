...
The Tavily tool connects your Arkady agents to an AI-native search engine built specifically for LLMs. Unlike traditional search APIs that return raw links, Tavily delivers clean, structured, and contextually relevant results ready for AI consumption.
...
Navigate to **Plugin Marketplace** in Arkady and search for "Tavily". Click **Install**.
...
Tavily requests from the Arkady integration include `X-Client-Name: arkady` for client attribution.
