...
from arkady_plugin.interfaces.model.large_language_model import LargeLanguageModel
...
class AnthropicLargeLanguageModel(LargeLanguageModel):
    ...
    def _process_assistant_message(
        ...
        # Arkady stores assistant text and tool calls separately; Anthropic expects the next
