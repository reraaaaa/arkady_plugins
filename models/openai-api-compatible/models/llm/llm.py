...
import requests
from arkady_plugin.entities.model import (
    AIModelEntity,
...
from arkady_plugin.entities.model.llm import LLMMode, LLMResult
...
from arkady_plugin.errors.model import CredentialsValidateFailedError, InvokeError
from arkady_plugin.interfaces.model.openai_compatible.llm import OAICompatLargeLanguageModel
...
class OpenAILargeLanguageModel(OAICompatLargeLanguageModel):
    ...
    def _wrap_thinking_by_reasoning_content(self, delta: dict, is_reasoning: bool) -> tuple[str, bool]:
        ...
        compatible with Arkady's downstream filters.
        """
    ...
    def get_customizable_model_schema(
        ...
        # Without these on entity.features, Arkady host filters out non-image attachments
    ...
    def _invoke(
        ...
        # Compatibility adapter for Arkady's 'json_schema' structured output mode.
