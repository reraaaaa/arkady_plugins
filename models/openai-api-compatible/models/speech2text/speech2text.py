...
import requests
from arkady_plugin.entities.model import AIModelEntity, FetchFrom, I18nObject, ModelType
from arkady_plugin.interfaces.model.openai_compatible.speech2text import OAICompatSpeech2TextModel
